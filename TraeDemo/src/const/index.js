...
export const RULE = {
    ...
    VCODE: [{pattern: /^\d{6}$/, message: '验证码必须为6位数字'}],
...
export const PROJECT_SKILLS = [
    ...
    {label: '前端服务器', value: 'node', version: '20.12.0'},
    {label: 'Vue脚手架', value: 'vite', version: '5.5.1'},
    ...
    {label: 'AJAX产品', value: 'axios', version: '1.6.7'},
    {label: 'WEB框架', value: 'element-plus', version: '2.5.3'},
    ...
    {label: '用户前端', value: '微信小程序', version: '最新版'}
];
