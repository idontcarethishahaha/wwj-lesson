...
public class FollowController {
    ...
    public boolean save(@RequestBody @Parameter(description="收藏表") FollowInsertDTO follow) {
    ...
    public PageVO<Follow> page(@Parameter(description="分页信息") FollowPageDTO page) {
