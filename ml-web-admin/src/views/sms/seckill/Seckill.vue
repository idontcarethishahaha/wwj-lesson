...
import {dateFormat, datetimeFormat, isNotEmpty, isNotNull, seckillStatusFormat} from "@/util/index.js";
...
const columns = [
  ...
  {label: '开始时间', prop: 'startTime', format: datetimeFormat},
  {label: '结束时间', prop: 'endTime', format: datetimeFormat},
